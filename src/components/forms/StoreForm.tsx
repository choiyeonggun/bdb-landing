  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h3 className="text-xl md:text-2xl font-bold text-gray-900">상가 문의</h3>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                업종 <span className="text-blue-600">*</span>
              </label>
              <input
                type="text"
                name="business"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                선호 층 <span className="text-blue-600">*</span>
              </label>
              <input
                type="text"
                name="floor"
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="화장실, 주방, 인테리어, 주차 등 필요하신 조건을 자유롭게 작성해주세요."
            />
          </div>
        </div>
